...
/**
 * M�canique du jeu Connect Four. Chaque joueur pose � son tour un jeton dans
 * une colonne de la grille. Le jeu s'arr�te lorsque quatre jetons de m�me
 * couleur sont align�s en ligne, en colonne ou en diagonale ou lorsque la
 * grille est remplie (auquel cas il y a match nul). A la cr�ation, le jeu est
 * initialis�.
 */
public interface Game {
	 ...
	 * 
	 * @return le jeton du joueur qui a remport� la partie si elle est termin�e et
	 *         qu'il n'y a pas eu de match nul.
	 */
	Tokens getWinner();
	...
	/**
	 * Initialise le jeu. Vide la grille et tire au sort le joueur qui commence.
	 */
	void init();
